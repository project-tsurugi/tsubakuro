...
/**
 * An interface to communicate with system service.
 * @see SystemClient
 * @since 1.13.0
 */
public interface SystemService extends ServerResource {

    /**
     * Requests {@code GetSystemInfo} to system service.
     ...
     */
    default FutureResponse<SystemResponse.SystemInfo> send(@Nonnull SystemRequest.GetSystemInfo request) throws IOException {
