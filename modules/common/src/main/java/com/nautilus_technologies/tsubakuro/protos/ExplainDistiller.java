...
public class ExplainDistiller implements Distiller<ResponseProtos.Explain> {
    @Override
    public ResponseProtos.Explain distill(ResponseProtos.Response response) throws IOException, ServerException {
	...
	if (ResponseProtos.Explain.ResultCase.ERROR.equals(detailResponse.getResultCase())) {
