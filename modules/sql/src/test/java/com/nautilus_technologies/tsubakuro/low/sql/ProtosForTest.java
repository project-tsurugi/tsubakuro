...
public class ProtosForTest {
	...
	public static boolean check(RequestProtos.Request dst, boolean checkSessionHandle) {
	    return
		(!checkSessionHandle || SessionChecker.check(dst.getSessionHandle()))
