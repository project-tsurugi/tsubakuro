...
public interface Transaction extends ServerResource {
     ...
     */
    FutureResponse<ResponseProtos.ResultOnly> executeStatement(String sql) throws IOException;
    ...
    */
    FutureResponse<ResultSet> executeQuery(String sql) throws IOException;
     ...
     * @throws IOException error occurred in execute statement by the SQL service
     */
    FutureResponse<ResponseProtos.ResultOnly> executeStatement(PreparedStatement preparedStatement, RequestProtos.ParameterSet parameterSet) throws IOException;
    @Deprecated
    FutureResponse<ResponseProtos.ResultOnly> executeStatement(PreparedStatement preparedStatement, RequestProtos.ParameterSet.Builder parameterSet) throws IOException;
     ...
     * @throws IOException error occurred in execute query by the SQL service
     */
    FutureResponse<ResultSet> executeQuery(PreparedStatement preparedStatement, RequestProtos.ParameterSet parameterSet) throws IOException;
    @Deprecated
    FutureResponse<ResultSet> executeQuery(PreparedStatement preparedStatement, RequestProtos.ParameterSet.Builder parameterSet) throws IOException;
     ...
     */
    FutureResponse<ResultSet> executeDump(PreparedStatement preparedStatement, RequestProtos.ParameterSet parameterSet, Path directory) throws IOException;
     ...
     */
    FutureResponse<ResponseProtos.ResultOnly> executeLoad(PreparedStatement preparedStatement, RequestProtos.ParameterSet parameterSet,	Collection<? extends Path> files) throws IOException;
